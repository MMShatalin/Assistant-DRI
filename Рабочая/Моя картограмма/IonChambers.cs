        ...
        public void ReDraw(Graphics g, int screanState, int PicWidth, Cartogram mycart)
            {
                switch (screanState)
                {
                    ...
                    this._cordDI6.X = mycart.getTVSByTVS360Number(148).CanvasCord.X - (int)(mycart.getFstep() * 2.8);
                    this._cordDI6.Y = mycart.getTVSByTVS360Number(148).CanvasCord.Y;

                    this._cordDI4.X = mycart.getTVSByTVS360Number(48).CanvasCord.X - (int)(mycart.getFstep() * 3);
                    this._cordDI4.Y = mycart.getTVSByTVS360Number(48).CanvasCord.Y;


                    this._cordDI2.X = mycart.getTVSByTVS360Number(0).CanvasCord.X - (int)(mycart.getFstep() * 4);
                    this._cordDI2.Y = mycart.getTVSByTVS360Number(0).CanvasCord.Y;
                    ...
                    this._cordDI6.X = mycart.getTVSByTVS360Number(148).CanvasCord.X;
                    this._cordDI6.Y = mycart.getTVSByTVS360Number(148).CanvasCord.Y - (int)(mycart.getFstep() * 2.8);

                    this._cordDI4.X = mycart.getTVSByTVS360Number(48).CanvasCord.X;
                    this._cordDI4.Y = mycart.getTVSByTVS360Number(48).CanvasCord.Y - (int)(mycart.getFstep() * 3);

                    this._cordDI2.X = mycart.getTVSByTVS360Number(0).CanvasCord.X;
                    this._cordDI2.Y = mycart.getTVSByTVS360Number(0).CanvasCord.Y - (int)(mycart.getFstep() * 4);
            ...
            Pen mySKPPen = new Pen(Brushes.Blue);
            Pen myAFPPen = new Pen(Brushes.Red);
            ...
            g.FillEllipse(MyConst.DI6Brush, this._cordDI6.X - MyConst.DIsize, this._cordDI6.Y - MyConst.DIsize, MyConst.DIsize * 2, MyConst.DIsize * 2);
            g.DrawEllipse(myDIPen, this._cordDI6.X - MyConst.DIsize, this._cordDI6.Y - MyConst.DIsize, MyConst.DIsize * 2, MyConst.DIsize * 2);


            g.FillEllipse(MyConst.DI4Brush, this._cordDI4.X - MyConst.DIsize, this._cordDI4.Y - MyConst.DIsize, MyConst.DIsize * 2, MyConst.DIsize * 2);
            g.DrawEllipse(myDIPen, this._cordDI4.X - MyConst.DIsize, this._cordDI4.Y - MyConst.DIsize, MyConst.DIsize * 2, MyConst.DIsize * 2);

            g.FillEllipse(MyConst.DI2Brush, this._cordDI2.X - MyConst.DIsize, this._cordDI2.Y - MyConst.DIsize, MyConst.DIsize * 2, MyConst.DIsize * 2);
            g.DrawEllipse(myDIPen, this._cordDI2.X - MyConst.DIsize, this._cordDI2.Y - MyConst.DIsize, MyConst.DIsize * 2, MyConst.DIsize * 2);



            // Pen myDefaultPen = new Pen(Brushes.LightGray);
